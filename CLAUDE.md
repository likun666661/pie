...
- `examples/` — runnable demos, not workspace members. `examples/mcp-notify-python/` is a stdlib-only Python MCP server that pushes notifications into pie's trigger runtime; see its README for wiring.
